                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img src="{{ $data->thumbnail }}" class="avatar avatar-sm rounded-circle me-2" alt="">
                          </div>
                          <div class="my-auto">
                      ...
                      <td class="align-middle">
                        <div class="btn-group" role="group" aria-label="Button group">
                          ...
                          <a class="shadow border-radius-md bg-white btn btn-link text-secondary m-2" href="{{ route('audio.edit', $data->id) }}">
