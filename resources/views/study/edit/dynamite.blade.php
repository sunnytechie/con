            ...
            <div class="card-body pt-0">
              ...
              <form action="{{ route('studies.updateDailyDynamite', $id) }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control @error('study_text') is-invalid @enderror" id="editor" name="study_text" rows="3" placeholder="Provide Study Text">{{ $study_text ?? old('study_text') }}</textarea>
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('anchor_verse_number') is-invalid @enderror" id="anchor_verse_number" name="anchor_verse_number" value="{{ $anchor_verse_number ?? old('anchor_verse_number') }}" placeholder="Provide Anchor Verse Number" required>
