...
<div class="container-fluid py-4">
    ...
    <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header d-flex justify-content-start pb-0">
              <div>
                <div class="dropdown">
                   ...
                   <tbody>
                    ...
                    <td class="align-middle">
                      <div class="btn-group" role="group" aria-label="Button group">
                        ...
                        <a class="shadow border-radius-md bg-white btn btn-link text-secondary m-2" href="{{ route('studies.editDailyDynamite', $book->id) }}">
