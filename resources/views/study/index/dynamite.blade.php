    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h3 class="card-title">Daily Dynamite</h3>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    ...
                    <div class="modal-content modal-content-demo">
                        ...
                        <div class="modal-header">
                            <h6 class="modal-title">Daily Dynamites</h6><button type="button" aria-label="Close" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{ route('studies.editDailyDynamite', $book->id) }}" class="btn btn-sm btn-warning"><i class="fe fe-edit-3"></i> Edit</a>
