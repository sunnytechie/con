        ...
        <div class="col-md-8">
          <div class="card mb-4">
            ...
            <div class="card-body p-4">
                <form method="post" action="{{ route('book.category.update', $categoryID) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                  ...
                  <div class="mb-3">
                    ...
                    <div class="btn-group" role="group" aria-label="Button group">
                        <a href="{{ route('books.categories.index') }}" type="button" class="btn btn-danger" data-dismiss="modal">Back</a>
