        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header d-flex justify-content-between pb-0">
              ...
              <button class="btn btn-default" type="button"> <span><i class="fa fa-plus-circle px-2" aria-hidden="true"></i></span> Compose </button>
            </div>
                ...
                <table class="table align-items-center justify-content-center mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p class="text-sm font-weight-bold mb-0">Lorem text</p>
                      </td>
